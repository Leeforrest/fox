...
import com.coolfish.gmserver.common.ExcelReader.RowConverter;

public class Test {
	public static void main(String[] args) throws InvalidFormatException, IOException {
		RowConverter<ExcelObj>converter = (row)->new ExcelObj(row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[7],row[8],row[9],row[10]);
